...
public class DBContract {
	...
	public final static String DB_PASSSWORD = "user2";
	...
	public final static String ORDER_INSERT =
					...
					+ORDER.COL_O_NUM_STR + ","
					+ORDER.COL_PO_DATE_STR + ","
					+ORDER.COL_O_CNUM_STR+ ","
					+ORDER.COL_O_PCODE_STR + ","
					+ORDER.COL_O_PRICE_INT + ","
					+ORDER.COL_O_QTY_INT 
					+ ") VALUES ("
					+ ORDER.SEQUENCE_NEXTVAL 	// O_SEQ 칼럼값을 INSERT를 수행할때 자동세팅
					+", ? , ? , ? , ? , ? , ?"
					+ " ) ";
	...
	public static class ORDER {
		...
		public final static String COL_PO_DATE_STR = " po_date ";	//CHAR	//(10 BYTE)
		...
		public final static String COL_O_PNAME_STR = " o_pame ";		//NVARCHAR2	//(125 CHAR)
...
//		public final static int POS_O_NUM_STR  = 2; //"o_num";	//CHAR	//(6 BYTE)
//		public final static int POS_PO_DATE_STR = 3; //	"o_date";	//CHAR	//(10 BYTE)
//		public final static int POS_O_CNUM_STR = 4; //"o_cnum";		//CHAR	//(5 BYTE)
//		public final static int POS_O_PCODE_STR= 5;//" o_pcode";		//CHAR	//(6 BYTE)
//		public final static int POS_O_PNAME_STR = 6;//"o_pame";		//NVARCHAR2	//(125 CHAR)
//		public final static int POS_O_PRICE_INT = 7;//"o_price";		// NUMBER
//		public final static int POS_O_QTY_INT= 8;//"o_qty";		// NUMBER
//		public final static int POS_O_TOTAL_INT = 9;//"o_total";		// NUMBER
